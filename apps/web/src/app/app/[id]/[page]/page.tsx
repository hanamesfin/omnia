...
export default function ProductAppPage() {
  ...
  if (error) {
    return (
      <div className="flex h-dvh flex-col items-center justify-center gap-3 px-4 text-sm text-muted">
        <p>{error}</p>
  ...
  if (!agent) {
    return (
      <div className="flex h-dvh items-center justify-center px-4" aria-busy>
